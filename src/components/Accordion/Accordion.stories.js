...
const item1 = () => <AccordionItem title='Hva er hentefristen?'>
...
const item2 = () => <AccordionItem title='Hvordan finner jeg hvilket hentested som tilhører min adresse?' initialExpanded={ true }>
